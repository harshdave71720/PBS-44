...
import type { VarshikUtsavSection } from "@/data/varshik-utsav"

interface UtsavTableOfContentsProps {
  sections: VarshikUtsavSection[]
}

export function UtsavTableOfContents({ sections }: UtsavTableOfContentsProps) {
  return (
    <nav
